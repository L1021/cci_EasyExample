...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKey_Minus), 11, 0, 
		...
		XYREF(Button_minus, 227, 179),
		XYREF(Button_minusminus, 227, 404),
		XYREF(InputNumber_Tagesziel, 51, 420),
		XYREF(InputNumber_Gesamtziel, 49, 176),
	...
	ID(SoftKey_Minus), TYPEID_SKEYMASK, COLOR(230), 6, 0, 
	...
	ID(SoftKey_minus), TYPEID_SOFTKEY, COLOR(214), 1, 1, 0, 
		XYREF(OutputString_11008, 5, 30),
	...
	ID(Button_minus), TYPEID_BUTTON, WORD(76), WORD(69), 187, 138, 1, 0, 1, 0, 
		XYREF(OutputString_11006, 0, 22),
	ID(Button_minusminus), TYPEID_BUTTON, WORD(76), WORD(67), 187, 173, 1, 0, 1, 0, 
		XYREF(OutputString_11007, -4, 18),
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(129), WORD(32), COLOR_LIME, ID(FontAttributes_Default), 0, 
		ID(NumberVariable_Tagesziel), LONG(123UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 2, 1, 0, 
	ID(InputNumber_Gesamtziel), TYPEID_INNUM, WORD(146), WORD(31), COLOR_YELLOW, ID(FontAttributes_Default), 0, 
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(68), WORD(38), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(76), WORD(29), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), '-', '-', ' ', ' ', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(70), WORD(25), COLOR_SILVER, ID(FontAttributes_Default), 1,
